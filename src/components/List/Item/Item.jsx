...
export const Item = ({
  story: { title, url, author, num_comments, points, objectID}, handleRemoveStory
}) => {
  return (
    <StyledItem>
      ...
      <StyledItemContent  width="10%">
        <StyledButtonSmall type="button" onClick ={()=>handleRemoveStory(objectID)} >Dismiss</StyledButtonSmall>
      </StyledItemContent>
    </StyledItem>
  );
};
